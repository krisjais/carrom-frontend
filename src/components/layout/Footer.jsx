...
export const Footer = () => {
  return (
    <footer className="w-full bg-[#070B16] border-t border-[#1C2B48] text-[#94A3B8] text-xs mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Col 1: Brand Summary */}
          <div className="space-y-3">
            <div className="flex items-center gap-2.5">
              <div className="w-7 h-7 rounded-lg bg-[#D4AF37] flex items-center justify-center text-[#070B16] font-display font-black text-sm">
                C
              </div>
            ...
            <p className="text-[12px] text-[#94A3B8] leading-relaxed max-w-xs">
              Annual Inter-College Carrom Championship platform. Clean dynamic knockout draws, live scoring, and official Tournament Rules.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/registration" className="hover:text-[#D4AF37] transition-colors">Register Entry</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/admin/login" className="text-[#D4AF37] hover:underline font-mono">Admin Console</Link></li>
            </ul>
          </div>
        </div>

        <div className="pt-6 border-t border-[#1C2B48]/60 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px]">
          <p>© 2026 Carrom Championship. Built for College Sports Tournaments.</p>
          <p className="text-[#64748B]">Best of 3 Boards Format • Tournament Rules</p>
        </div>
      </div>
    </footer>
  );
