      ...
      <div className="relative z-10 w-full max-w-md bg-[#171614]/85 dark:bg-[#11100E]/90 backdrop-blur-xl border border-white/15 rounded-3xl p-7 sm:p-10 shadow-2xl text-[#F7F4EC]">
        ...
        <div className="text-center space-y-2 mb-6">
          ...
          <p className="text-xs text-[#F7F4EC]/70 font-sans max-w-xs mx-auto">
            Enter authorized credentials to manage tournament draws, schedules, and live matches.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          <div className="flex items-center justify-between text-xs text-[#F7F4EC]/70 pt-1">
            ...
            <Link href="/participant/login" className="hover:text-white underline underline-offset-4 text-[#C2A268]">
              ← Athlete Login
            </Link>
          </div>
        ...
        <div className="mt-6 pt-5 border-t border-white/15 flex items-center justify-center gap-2 text-center text-[11px] text-[#F7F4EC]/50 font-mono">
          <Lock className="w-3.5 h-3.5 text-[#C2A268]" />
